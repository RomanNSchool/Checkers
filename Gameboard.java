...
class Gameboard {
  ...
  /*
   * Creates a gameboard object in default position
  */
  public Gameboard() {
   ...
   * 
   * @return List<Piece> - list of pieces of a team that can capture a piece of
   * another team
   */
  ...
  /*
   * Get all the pieces of a team that can make a non-capturing move
   * 
   * @param team - String type - team to check
   * 
   * @return List<Piece> - list of pieces of a team that have a non-capturing move
   */
  public List<Piece> piecesThatCanReposition(String team) {
    List<Piece> pieces = new ArrayList<Piece>();
    if (team.equals("mouse")) {
      for (int i = 0; i < mousePieces.size(); i++) {
        // add to list if piece can capture another piece
        if (mousePieces.get(i).possibleRepositioning(this).isEmpty() == false) {
          pieces.add(mousePieces.get(i));
        }
      }
    } else {
      for (int i = 0; i < catPieces.size(); i++) {
        if (catPieces.get(i).possibleRepositioning(this).isEmpty() == false) {
          pieces.add(catPieces.get(i));
        }
      }
    }
  ...
  /*
   * Get all the pieces of a team that have a valid move
   * 
   * @param team - String type - team to check
   * 
   * @return List<Piece> - list of pieces of a team that have a valid move
   */
  public List<Piece> piecesThatCanMove(String team){
    List<Piece> repositioning = piecesThatCanReposition(team);
    List<Piece> captures = piecesThatCanCapture(team);
   ...
   * 
   * @return Piece[][] - 2D Piece Array of board base state
   */
  ...
  /*
   * Set a piece to a specific position, remove pieces that it captured, and
   * promote it if necessary
   * 
   * @param position - int[] type - position where piece will be set to,
  ...
  public void setPiece(int[] position, Piece piece) {
    int row = position[0];
    int column = position[1];
    // check to see if it captured a piece when moving upwards diagonally to the
    // right
    ...
    // remove piece from its current square, second parameter is false because piece
    // is still in play
  ...
  /*
   * Convert board to string 2d array
   * @return String[][] - string as 2d array
   */
  ...
  public void displayBoard() {
    ...
    System.out.println(
        "8|" + textBoard[0][0] + "|" + textBoard[0][1] + "|" + textBoard[0][2] + "|" + textBoard[0][3] + "|"
            + textBoard[0][4] + "|" + textBoard[0][5] + "|" + textBoard[0][6] + "|" + textBoard[0][7] + "|" + "\n" +
            "7|" + textBoard[1][0] + "|" + textBoard[1][1] + "|" + textBoard[1][2] + "|" + textBoard[1][3] + "|"
            + textBoard[1][4] + "|" + textBoard[1][5] + "|" + textBoard[1][6] + "|" + textBoard[1][7] + "|" + "\n" +
            "6|" + textBoard[2][0] + "|" + textBoard[2][1] + "|" + textBoard[2][2] + "|" + textBoard[2][3] + "|"
            + textBoard[2][4] + "|" + textBoard[2][5] + "|" + textBoard[2][6] + "|" + textBoard[2][7] + "|" + "\n" +
            "5|" + textBoard[3][0] + "|" + textBoard[3][1] + "|" + textBoard[3][2] + "|" + textBoard[3][3] + "|"
            + textBoard[3][4] + "|" + textBoard[3][5] + "|" + textBoard[3][6] + "|" + textBoard[3][7] + "|" + "\n" +
            "4|" + textBoard[4][0] + "|" + textBoard[4][1] + "|" + textBoard[4][2] + "|" + textBoard[4][3] + "|"
            + textBoard[4][4] + "|" + textBoard[4][5] + "|" + textBoard[4][6] + "|" + textBoard[4][7] + "|" + "\n" +
            "3|" + textBoard[5][0] + "|" + textBoard[5][1] + "|" + textBoard[5][2] + "|" + textBoard[5][3] + "|"
            + textBoard[5][4] + "|" + textBoard[5][5] + "|" + textBoard[5][6] + "|" + textBoard[5][7] + "|" + "\n" +
            "2|" + textBoard[6][0] + "|" + textBoard[6][1] + "|" + textBoard[6][2] + "|" + textBoard[6][3] + "|"
            + textBoard[6][4] + "|" + textBoard[6][5] + "|" + textBoard[6][6] + "|" + textBoard[6][7] + "|" + "\n" +
            "1|" + textBoard[7][0] + "|" + textBoard[7][1] + "|" + textBoard[7][2] + "|" + textBoard[7][3] + "|"
            + textBoard[7][4] + "|" + textBoard[7][5] + "|" + textBoard[7][6] + "|" + textBoard[7][7] + "|");
    System.out.println(" -----------------");
  }
}